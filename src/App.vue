...
export default {
  ...
  methods: {
    add() {
      ...
      setInterval(async () => {
        const f = await fetch(
          `https://min-api.cryptocompare.com/data/price?fsym=${newTicker.name}&tsyms=USD,JPY,EUR&api_key=de7c9cfd59397921c8fbd17446a0b0f1dd2cd2cd6188d98122d04819b7008a8b`
        );
